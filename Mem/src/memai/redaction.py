"""Regex-based secret redaction for Mem and host log/output boundaries.
...
# `export VOIDCUBE_REDACT_SECRETS=false`) cannot disable redaction mid-session.
_REDACT_ENABLED = os.getenv("VOIDCUBE_REDACT_SECRETS", "").lower() not in ("0", "false", "no", "off")
