...
class MemoryServiceConfig(BaseModel):
    ...
    tier2_min_event_coverage: float = Field(default=1.0, ge=0.0, le=1.0)
    ...
    longitudinal_consolidation_mode: str = Field(default="auto", pattern="^(auto|shadow|disabled)$")
    longitudinal_consolidation_min_cluster_size: int = Field(default=3, ge=2, le=50)
    longitudinal_consolidation_min_confidence: float = Field(default=0.7, ge=0.0, le=1.0)
    longitudinal_consolidation_limit: int = Field(default=20, ge=1, le=200)
