...
def _normalize_model_version(model: str) -> str:
    ...
    Nous uses dashes: gpt-5-1, gpt-4-1
    OpenRouter uses dots: gpt-5.1, gpt-4.1
...
def _resolve_nous_context_length(model: str) -> Optional[int]:
    ...
    Nous model IDs are bare (e.g. 'gpt-5-1') while OpenRouter uses
    prefixed IDs (e.g. 'openai/gpt-5.1'). Try suffix matching
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Voidcube sends to providers:
