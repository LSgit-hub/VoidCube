...
## Example 8: Third-party MaaS Model (external-model-v1)

**Scenario:** Deploy external-model-v1 (third-party MaaS model requiring modelProviderData).
...
| **8: third-party MaaS** | ~2m | Industry prompt, tenant info, REST API deploy |
