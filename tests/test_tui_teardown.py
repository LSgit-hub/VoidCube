from voidcube.interfaces.cli.tui.teardown import TuiTeardownPorts, run_tui_teardown
...
def test_run_tui_teardown_preserves_cleanup_order() -> None:
    ...
    run_tui_teardown(
        TuiTeardownPorts(
            ...
            close_session_owner=operation("session-owner"),
...
def test_run_tui_teardown_does_not_hide_owner_failures() -> None:
    ...
    ports = TuiTeardownPorts(
        ...
        close_session_owner=lambda: calls.append("session-owner"),
