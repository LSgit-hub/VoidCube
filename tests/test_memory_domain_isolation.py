...
async def test_companion_recall_dereferences_only_active_promotions(tmp_path):
    ...
    # Ordinary context is model-facing and intentionally omits internal
    # promotion identifiers; the structured result remains the audit channel.
    assert f"promotion={promotion_id}" not in recalled["context"]
