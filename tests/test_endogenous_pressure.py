from voidcube.systems.supervisor.endogenous_pressure import (
...
def test_urgency_projections_keep_existing_idle_and_governance_semantics():
    formal = {
        "idle_seconds": {"user": 900, "employee_execution": 0, "agent": 900, "memory": 900}
    }
    missing_employee_execution = {"idle_seconds": {"user": 900, "agent": 900, "memory": 900}}
    formal_idle = {
        "idle_seconds": {"user": 900, "employee_execution": 900, "agent": 0, "memory": 900}
    }
