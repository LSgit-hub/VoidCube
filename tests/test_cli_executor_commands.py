...
from voidcube.interfaces.cli.entrypoints.operations import cmd_body
...
def test_body_status_command_uses_executor_ops_client(capsys):
    ...
    with patch("voidcube.infrastructure.gateway.executor.ExecutorOpsClient", return_value=client):
        cmd_body(
            SimpleNamespace(
                body_action="status",
