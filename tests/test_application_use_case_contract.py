...
from voidcube.domain.contracts.events import SessionEventKind
from voidcube.application.sessions import HistoryMutationStatus, SessionTitleStatus
...
class _Repository:
    ...
    @staticmethod
    def resolve_resumable_session_id(session_id: str) -> str:
        return session_id
