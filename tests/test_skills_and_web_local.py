...
import voidcube.extensions.skills.catalog as skill_utils
import voidcube.extensions.skills.hub as skills_hub
import voidcube.extensions.skills.tool as skills_tool
import voidcube.extensions.tools.web.web_tools as web_tools
import voidcube.extensions.tools.web.web_tools_local as web_tools_local
...
def test_web_search_local_backend_uses_local_crawler(monkeypatch):
    ...
    monkeypatch.setattr("voidcube.extensions.tools.web.web_tools_local.local_web_search", fake_local_web_search)
...
async def test_web_extract_local_backend_uses_local_crawler(monkeypatch):
    ...
    monkeypatch.setattr("voidcube.extensions.tools.web.web_tools_local.local_web_extract", fake_local_web_extract)
...
async def test_web_crawl_local_backend_uses_local_crawler(monkeypatch):
    ...
    monkeypatch.setattr(
        "voidcube.extensions.tools.web.web_tools_local.local_web_crawl",
...
def test_local_web_extract_uses_matching_saved_account_cookie(monkeypatch):
    ...
    monkeypatch.setattr(
        "voidcube.systems.supervisor.account_store.cookie_header_for_url",
