                ...
                return _FakeUrlopenResponse({
                    "task": {
                        ...
                        "constraints": {
                            ...
                            "authoring_result_id": "evolution-authoring-result-" + "2" * 64,
                            "evaluated_baseline_commit": "b" * 40,
                            "evaluated_candidate_commit": "a" * 40,
                            "candidate_ref": "refs/voidcube/candidates/cli-test",
                            ...
                            "authoring_environment_manifest_id": "execution-environment-" + "c" * 64,
                            "authoring_environment_identity_id": "execution-environment-identity-" + "d" * 64,
