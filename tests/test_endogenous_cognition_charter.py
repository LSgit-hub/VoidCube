...
from voidcube.systems.supervisor.config_models import EndogenousDriveCognitionCharterConfig
from voidcube.systems.supervisor.endogenous_cognition_charter import resolve_cognition_charter
