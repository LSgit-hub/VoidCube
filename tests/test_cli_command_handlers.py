...
from voidcube.interfaces.cli.commands.handlers.input import (
    QueueCommandPorts,
    RetryCommandPorts,
...
from voidcube.interfaces.cli.commands.handlers.history import (
    HistoryCommandPorts,
...
from voidcube.interfaces.cli.commands.handlers.rollback import (
...
from voidcube.interfaces.cli.commands.handlers.personality import (
    PersonalityCommandPorts,
    handle_personality_command,
)
from voidcube.interfaces.cli.commands.handlers.reasoning import (
    ReasoningCommandPorts,
    handle_reasoning_command,
)
from voidcube.interfaces.cli.commands.handlers.fast import (
    FastCommandPorts,
    handle_fast_command,
    parse_service_tier_config,
)
from voidcube.interfaces.cli.commands.handlers.compression import (
    CompressionCommandPorts,
    handle_compression_command,
)
from voidcube.interfaces.cli.commands.handlers.browser import (
    BrowserCommandPorts,
    handle_browser_command,
)
from voidcube.interfaces.cli.commands.handlers.autonomous import (
    AutonomousCommandPorts,
    handle_auto_command,
    handle_auto_q_command,
)
from voidcube.interfaces.cli.commands.handlers.background import (
    BackgroundCommandPorts,
    BackgroundCommandText,
    handle_background_command,
)
from voidcube.interfaces.cli.commands.handlers.btw import (
    BtwCommandPorts,
    BtwCommandText,
    handle_btw_command,
)
from voidcube.interfaces.cli.commands.handlers.language import (
    LanguageCommandPorts,
    handle_language_command,
)
from voidcube.interfaces.cli.commands.handlers.voice import (
    VoiceCommandPorts,
...
from voidcube.interfaces.cli.commands.handlers.plan import PlanCommandPorts, handle_plan_command
from voidcube.interfaces.cli.commands.handlers.mcp import (
    McpCommandPorts,
    handle_mcp_command,
)
from voidcube.interfaces.cli.commands.handlers.tools import (
    ToolsCommandPorts,
    ToolsCommandText,
    handle_tools_command,
)
from voidcube.interfaces.cli.commands.handlers.skills import (
    SkillRecord,
    SkillSearchResult,
    SkillsCommandPorts,
    handle_skills_command,
)
from voidcube.interfaces.cli.commands.handlers.session import (
    BranchCommandPorts,
    ClearCommandPorts,
...
from voidcube.interfaces.cli.session_command_adapter import ResumeSummaryLabels
...
def test_resume_handler_without_target_defaults_to_first_recent_session() -> None:
    output: list[str] = []
    resumed: list[str] = []
    ...
    handle_resume_command(
        ...
        ports=_resume_ports(
            output=output,
            list_recent_sessions=lambda: (
                {"id": "latest", "message_count": 0},
                {"id": "older", "message_count": 4},
            ),
    ...
    assert output == [
        "  ↻ Resumed session latest — no messages, starting fresh."
    ]
