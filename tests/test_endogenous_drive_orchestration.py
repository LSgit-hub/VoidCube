...
from voidcube.systems.supervisor.endogenous_drive_orchestration import (
...
from voidcube.systems.supervisor.autonomous_cycle_service import AutonomousCycleService
...
async def test_drive_orchestration_owner_runs_explicit_callback_pipeline():
    ...
    context = EndogenousDriveEvaluationContext(
        ...
        employee_execution_lane_task_summaries=lambda limit: [],
