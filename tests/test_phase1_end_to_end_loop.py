...
from voidcube.systems.supervisor.endogenous_learning import extract_learning_topic
...
class TestPhase1AbandonCandidateAction:
    ...
    def test_abandon_candidate_action_type_registered(self):
        ...
        from voidcube.systems.governor import GovernorAction, GovernorActionType
    ...
    def test_abandon_candidate_probe_to_shell_allowed(self):
        ...
        from voidcube.systems.body_registry import ALLOWED_STATE_TRANSITIONS
