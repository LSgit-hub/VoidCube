...
from voidcube.application.configuration import ApplicationConfigRuntime
from voidcube.infrastructure.gateway.presence import GatewayPresenceClient
from voidcube.infrastructure.providers.model_normalization import (
...
def test_cli_auth_adapter_uses_shared_provider_contract() -> None:
    cli_auth = importlib.import_module("voidcube.interfaces.cli.auth")
    provider_auth = importlib.import_module("voidcube.infrastructure.providers.credentials")
...
def test_cli_plugin_adapter_reuses_shared_registry() -> None:
    cli_plugins = importlib.import_module("voidcube.extensions.plugins.manager")
    shared_plugins = importlib.import_module("voidcube.extensions.plugins.manager")
