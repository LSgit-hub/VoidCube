"""Canonical runtime data layout for services and migration tooling."""
...
def get_runtime_layout(home: str | Path | None = None) -> RuntimeLayout:
    ...
    return RuntimeLayout(
        ...
        supervisor_governance_log=runtime_root / "supervisor" / "mem_governance.jsonl",
        body_root=body_root,
...
def get_legacy_project_runtime_layout(project_root: str | Path) -> LegacyProjectRuntimeLayout:
    """Return pre-M2 project-root locations used only as migration sources."""
