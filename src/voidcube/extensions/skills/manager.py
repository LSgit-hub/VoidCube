...
~/.VoidCube/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.VoidCube/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.VoidCube/skills/) first, then any
...
def _validate_file_path(file_path: str) -> Optional[str]:
    ...
    """
    from ..tools.files.path_security import has_traversal_component
...
def _resolve_skill_target(skill_dir: Path, file_path: str) -> Tuple[Optional[Path], Optional[str]]:
    ...
    from ..tools.files.path_security import validate_within_dir
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.VoidCube/skills/; existing skills can be modified wherever they live.\n\n"
