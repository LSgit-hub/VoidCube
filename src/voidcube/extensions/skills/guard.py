...
from ...domain.contracts.integration_policy import (
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.VoidCube/\.env|\~/\.VoidCube/\.env',
     "VoidCube_env_access", "critical", "exfiltration",
     "directly references Voidcube secrets file"),
