"""Shared debug session infrastructure for Voidcube tools.
...
Usage in a tool module:
    ...
    from voidcube.extensions.tools.debug_helpers import DebugSession
...
class DebugSession:
    ...
    def __init__(self, tool_name: str, *, env_var: str) -> None:
        ...
        self.log_dir = get_VoidCube_home() / "logs"
