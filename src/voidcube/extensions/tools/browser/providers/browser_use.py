...
from .....infrastructure.gateway.managed_tool_gateway import resolve_managed_tool_gateway
...
class BrowserUseProvider(CloudBrowserProvider):
    ...
    def create_session(self, task_id: str) -> Dict[str, object]:
        ...
        # default to a long Browser-Use timeout when Voidcube only needs a task-
        ...
        if managed_mode:
            _clear_pending_create_key(task_id)
        session_name = f"VoidCube_{task_id}_{uuid.uuid4().hex[:8]}"
