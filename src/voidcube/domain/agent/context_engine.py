...
class ContextEngine(ABC):
    ...
    # -- Token state (read by the Agent runtime for display/logging) --------
    #
    # Engines MUST maintain these. The Agent runtime reads them directly.
    ...
    # -- Compaction parameters (read by the Agent runtime for preflight) ----
    #
    ...
    def on_session_start(self, session_id: str, **kwargs) -> None:
        ...
        kwargs may include VoidCube_home, platform, model, etc.
        """
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        Default returns the standard fields expected by the Agent runtime.
        """
        return {
