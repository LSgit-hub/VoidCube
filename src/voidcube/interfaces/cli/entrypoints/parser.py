...
from .parser_chat import register_chat_command
from .parser_core import register_core_commands
from .parser_management import register_management_commands
from .parser_operations import register_operations_commands
from .parser_platform import register_platform_commands
