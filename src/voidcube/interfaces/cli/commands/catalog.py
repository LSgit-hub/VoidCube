...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goal", "管理当前会话目标", "会话管理",
               cli_only=True, args_hint="[objective|status|complete|blocked|resume|clear]",
               subcommands=("status", "complete", "blocked", "resume", "clear")),
    ...
    CommandDef("status", "显示会话状态或设置启动历史条数", "会话管理",
               args_hint="[1-10]"),
